...
async function loadDemoData(){
  ...
  const leads = [
    { id: utils().uuid(), isDemo: true, customerId: dewit.id, source: "Website", status: "Offerte verstuurd", requestedPackage: "Basis", estimatedValue: 375, eventDate: inDays(45), eventType: "Verjaardag", eventLocation: "Arnhem", notes: "Wacht op reactie op offerte.", createdAt: inDays(-10), lastContactAt: inDays(-9) },
    { id: utils().uuid(), isDemo: true, customerId: jansen.id, source: "Instagram", status: "Gewonnen", requestedPackage: "Premium", estimatedValue: 425, eventDate: inDays(14), eventType: "Bruiloft", eventLocation: "Nijmegen", notes: "", createdAt: inDays(-30), lastContactAt: inDays(-20) }
  ];
